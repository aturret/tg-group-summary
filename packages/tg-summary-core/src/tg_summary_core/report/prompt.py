...
DEFAULT_MEDIA_INSTRUCTION_REFERENCE = (
    "media 字段仅作参考（如\u201c发送了图片\u201d），无需深入分析媒体内容，除非文本中有上下文提及。"
)
...
def generate_telegram_message_daily_summary_prompt(
    ...
    media_instruction = DEFAULT_MEDIA_INSTRUCTION_ANALYZE if analyze_media else DEFAULT_MEDIA_INSTRUCTION_REFERENCE
